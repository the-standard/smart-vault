    ...
    function generateSvg(uint256 _tokenId, ISmartVault.Status memory _vaultStatus) external view returns (string memory) {
        ...
        string(
            abi.encodePacked(
                ...
                "<rect width='900' height='900' fill='url(#paint0_linear_428_47)'/>",
                "<circle cx='52.5' cy='751.5' r='328.5' fill='#FF3BC9'/>",
                "<g filter='url(#filter0_d_428_47)'>",
                "<rect x='57' y='153' width='787' height='553' rx='72' fill='url(#paint1_linear_428_47)'/>",
                "<rect x='58.5' y='154.5' width='784' height='550' rx='70.5' stroke='white' stroke-opacity='0.14' stroke-width='3'/>",
                "</g>",
                "<rect x='57' y='261' width='787' height='445' rx='72' fill='url(#paint2_linear_428_47)'/>",
                ...
                "<text x='115' y='223' font-weight='bold' font-family='Arial' font-size='18' fill='white'> &#8364; </text>",
                "<text x='150' y='223' font-weight='bold' font-family='Arial' font-size='18' fill='white'>EUROs SmartVault</text>",
                ...
                "<text x='645' y='223' font-weight='bold' font-family='Arial' font-size='18' fill='white'>TheStandard.io</text>",
                "<text x='130' y='400' font-family='Arial' font-size='40' font-weight='900' fill='white'>THE OWNER OF THIS NFT OWNS</text>",
                "<text x='170' y='440' font-family='Arial' font-size='40' font-weight='900' fill='white'>THE COLLATERAL AND DEBT</text>",
                "<text x='350' y='310' font-family='Arial' font-size='18' fill='white'>EUROs SmartVault # ", _tokenId.toString(), "</text>",
                "<text x='145' y='490' font-family='Arial' font-size='14' fill='white' text-anchor='middle'>Total Value</text>",
                "<rect x='107' y='504' width='132' height='40' rx='11' fill='#DA76EE'/>",
                "<text x='170' y='528' font-family='Arial' font-size='14' fill='white' font-weight='bold' text-anchor='middle'>&#8364; ",
                    NFTUtils.toDecimalString(_vaultStatus.totalCollateralValue, 18),
                "</text>",
                "<text x='280' y='490' font-family='Arial' font-size='14' fill='white' text-anchor='middle'>Debt</text>",
                "<rect x='263' y='504' width='132' height='40' rx='11' fill='#9F8CF2'/>",
                "<text x='325' y='528' font-family='Arial' font-size='14' fill='white' font-weight='bold' text-anchor='middle'>&#8364;",
                    NFTUtils.toDecimalString(_vaultStatus.minted, 18),
                "</text>",
                "<text x='470' y='490' font-family='Arial' font-size='14' fill='white' text-anchor='middle'>Collateral/Debt</text>",
                "<rect x='419' y='504' width='132' height='40' rx='11' fill='#979DFA'/>",
                "<text x='485' y='528' font-family='Arial' font-size='14' fill='white' font-weight='bold' text-anchor='middle'>",
                    collateralDebtPecentage(_vaultStatus),
                "</text>",
                "<text x='720' y='490' font-family='Arial' font-size='14' fill='white' text-anchor='middle'>Total Minus Debt</text>",
                "<rect x='662' y='504' width='132' height='40' rx='11' fill='url(#paint4_linear_428_47)'/>",
                "<text x='730' y='528' font-family='Arial' font-size='14' fill='white' font-weight='bold' text-anchor='middle'>&#8364;",
                    NFTUtils.toDecimalString(_vaultStatus.totalCollateralValue - _vaultStatus.minted, 18),
                "</text>",
                "<text x='221' y='622' font-family='Arial' font-size='18' fill='white' text-anchor='middle'>Collateral locked in this vault</text>",
                "<text x='790' y='628' font-family='Arial' font-size='18' font-weight='bold' fill='white' text-anchor='end'>&#8364; 84 </text>",
                "<rect x='107' y='640' width='687' height='16' rx='8' fill='#AC99F7'/>",
                "<!--  width paran === Substitute with value! 690 = 100%  -->",
                "<rect x='107' y='640' width='",calculateCollateralLockedWidth(0),"' height='16' rx='8' fill='white'/>",
                "</g>",
                "<defs>",
