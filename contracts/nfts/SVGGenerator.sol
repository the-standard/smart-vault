    ...
    function generateSvg(uint256 _tokenId, ISmartVault.Status memory _vaultStatus) external view returns (string memory) {
        ...
        string(
            abi.encodePacked(
                ...
                "<circle cx='52.5' cy='751.5' r='328.5' fill='#FF3BC9'/>", "<g>", "<rect x='57' y='153' width='787' height='553' rx='72' fill='url(#paint1_linear_428_47)' fill-opacity='0.3'/>",
                "<rect x='58.5' y='154.5' width='784' height='550' rx='70.5' stroke='white' stroke-opacity='0.14' stroke-width='3'/>", "</g>",
                "<rect x='57' y='261' width='787' height='445' rx='72' fill='url(#paint2_linear_428_47)' fill-opacity='0.3'/>", "<rect x='57' y='261' width='787' height='445' rx='72' fill='url(#paint3_radial_428_47)' fill-opacity='0.74'/>",
