    ...
    function generateSvg(uint256 _tokenId, ISmartVault.Status memory _vaultStatus) external view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                "<text x='115' y='223' font-weight='bold' font-size='18'> &#8364; </text>", "<text x='150' y='223' font-weight='bold' font-size='18'>USDs SmartVault</text>",
                ...
                "<text x='350' y='310' font-size='18'>USDs SmartVault # ", _tokenId.toString(), "</text>",
