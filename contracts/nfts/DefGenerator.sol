...
//             colours[(_tokenId % colours.length + _tokenId / colours.length + _tokenId / colours.length ** 2 + 2)
//                 % colours.length]
//         );
//     }
...
//                 _tokenId.toString(),
//                 "' x1='315' y1='1935' x2='2565' y2='-315' gradientTransform='matrix(1, 0, 0, 1, 0, 0)' gradientUnits='userSpaceOnUse'>",
//                 "<stop offset='.38' stop-color='",
//                 NFTUtils.toShortString(gradient.colour1),
//                 "'/>",
//                 "<stop offset='.77' stop-color='",
//                 NFTUtils.toShortString(gradient.colour2),
//                 "'/>",
//                 "<stop offset='1' stop-color='",
//                 NFTUtils.toShortString(gradient.colour3),
//                 "'/>",
//                 "</linearGradient>",
//                 "</defs>"
//             )
