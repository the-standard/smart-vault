...
string constant DEFAULT_RPC_URL = "https://arb1.arbitrum.io/rpc";
...
ERC20 constant USDT = ERC20(USDT_ADDRESS);
ERC20 constant WSTETH = ERC20(WSTETH_ADDRESS);
...
bytes32 constant USDT_SYMBOL = hex"555344e282ae3000000000000000000000000000000000000000000000000000";
bytes32 constant WSTETH_SYMBOL = "wstETH";
...
address constant USDT_WHALE = 0x5a52E96BAcdaBb82fd05763E25335261B270Efcb;
...
address constant CL_USDT_USD_ADDRESS = 0x3f3f5dF88dC9F13eac63DF89EC16ef6e7E25DdE7;
address constant CL_USDC_USD_ADDRESS = 0x50834F3163758fcC1Df9973b6e91f0F0F0434aD3;
address constant CL_WSTETH_ETH_ADDRESS = 0xb523AE262D20A936BC152e6023996e46FDC2A95D;
...
AggregatorV3Interface constant CL_USDT_USD = AggregatorV3Interface(CL_USDT_USD_ADDRESS);
...
address constant USDT_HYPERVISOR_ADDRESS = 0x95375694685E39997828Ed5B17f30f0A3eD90537;
address constant WSTETH_HYPERVISOR_ADDRESS = 0xa7FCe463815f18DbE246152C5291B84db07c0bcd;
...
IHypervisor constant USDT_HYPERVISOR = IHypervisor(USDT_HYPERVISOR_ADDRESS);
IHypervisor constant WSTETH_HYPERVISOR = IHypervisor(WSTETH_HYPERVISOR_ADDRESS);

// Protocol constants
bytes32 constant NATIVE = "ETH";
uint256 constant COLLATERAL_RATE = 110_000; // 110%
uint256 constant PROTOCOL_FEE_RATE = 500; // 0.5%
uint24 constant SMALL_FEE = 100; // 0.01%
